...
<body class="easyui-layout">
	...
	<div region="center" border="false" border="false">
		<div class="easyui-tabs" fit="true" id="tt">
			<div title="Flaging Manual" style="padding:10px;background:#e1e6f9" >
				<div style="padding: 0 5px 5px 5px">
					<div class="easyui-panel" title="Pencarian Data Berdasarkan No Agenda" style="width:98%;padding: 10px 13px 10px 10px">	
								...
								<table width="100%">	
									...
									<td width="7%">
										...
										<td width="15%"> 
											...
											<input value="<?php echo $this->session->userdata('unit_up');?>" type="hidden" name="inUnitUpUser" id="inUnitUpUser" data-options="required:false,readonly:true" style="width:100%;"></input>
										</td>
										<td width="7%"></td>
										<td width="7%"></td>
										<td width="7%"></td>
									...
									<td width="7%">
										...
										<td width="7%">
											<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-save'" style="float:lefts;width:100%;height:26px;" id="bsimpan" onclick="simpan()" disabled>SIMPAN</a>
										</td>
										<td width="7%">
											<!-- <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-print'" style="float:lefts;width:100%;height:26px;" id="bcetak" disabled>CETAK</a> -->
										</td>
										<td width="15%">
										</td>
									</tr>
